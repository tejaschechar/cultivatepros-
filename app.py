...
disease_model_path = os.getenv("DISEASE_MODEL_PATH", "efficientnet_model_v1_full_94%")
crop_recomadation_model_path = os.getenv("CROP_RECOMMENDATION_MODEL_PATH", "RandomForest.pkl")
#fertilizer_prediction_path = os.getenv("FERTILIZER_PREDICTION_PATH", "models/RandomForestForFertilizer.pkl")
dataset_path = os.getenv("DATASET_PATH", "fertilizer.csv")

# Load models
disease_model = tf.keras.models.load_model(disease_model_path)

with open(crop_recomadation_model_path, 'rb') as crop_model_file:
    crop_recomadation_model = pickle.load(crop_model_file)

"""with open(fertilizer_prediction_path, 'rb') as fertilizer_model_file:
    fertilizer_prediction_model = pickle.load(fertilizer_model_file)"""
